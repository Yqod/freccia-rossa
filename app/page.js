...
export default function Home() {
  return (
    <>
      <main>
        <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-black px-4 pb-16 sm:px-6 lg:items-start lg:justify-end lg:px-16 lg:pb-20 xl:px-24">
          <video
          ...
          <Heading
            ...
            thick="in Magdeburg"
            className="relative z-10 max-w-5xl text-center text-5xl text-white drop-shadow-lg sm:text-6xl md:text-7xl lg:max-w-3xl lg:text-left lg:text-8xl xl:max-w-4xl xl:text-9xl"
          />

          <div className="relative z-10 mt-8 flex flex-col items-center gap-4 sm:flex-row lg:items-start lg:justify-start">
            <a
              href="#preise"
