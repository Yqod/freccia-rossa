          ...
          <>
            ...
            <motion.div
              ...
              <div className="h-screen overflow-y-auto flex flex-col">
                <div
                  className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 w-full flex-1 flex flex-col justify-between">
              ...
              <AnimatePresence initial={false}>
                {hoveredIndex !== null && (
                  <motion.div
                    ...
                    <div
                      className="w-48 h-32 sm:w-64 sm:h-48 rounded-2xl overflow-hidden shadow-2xl border border-neutral-200 dark:border-neutral-800 bg-neutral-100 dark:bg-neutral-900">
                      <motion.img
