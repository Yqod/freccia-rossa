    ...
    <section
      ...
      <motion.div
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="absolute bottom-6 left-1/2 -translate-x-1/2 inline-flex items-center gap-2 rounded-lg bg-white px-5 py-3 text-sm font-medium text-neutral-900 shadow-lg transition-colors hover:bg-neutral-100">
